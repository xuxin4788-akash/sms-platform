...
- Recommended SES sending identity: subdomain **`app.pagoserve.com`** (from `noreply@app.pagoserve.com`); configure SPF/DKIM/DMARC there. SES SMTP endpoint already preset (`email-smtp.us-east-1.amazonaws.com:587 STARTTLS`).
