...
function showImportModal() {
    api('/api/groups').then(function(data) {
        ...
        var templateBox = '' +
            ...
            '<span style="display:block;font-size:12px;color:#64748B;margin-top:2px;">La columna APP tiene lista desplegable con las APP configuradas</span>' +
            '</span>' +
